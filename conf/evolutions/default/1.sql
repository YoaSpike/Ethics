...
alter table ethics_form_model add constraint fk_ethics_form_model_owner_1 foreign key (owner_curtin_id) references user_model (curtin_id) on delete restrict on update restrict;
create index ix_ethics_form_model_owner_1 on ethics_form_model (owner_curtin_id);
